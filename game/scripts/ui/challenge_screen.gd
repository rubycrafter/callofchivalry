...
func setup_challenge(challenge: Challenge, actions: Array, location_name: String = "") -> void:
	...
	for i in range(actions.size()):
		...
		# Format button text based on action type
...
func show_action_result(action: Challenge.ChallengeAction) -> void:
	# Show result message
	if result_label:
